...
const SearchBar: FC<SearchBarProps> = ({ isLoading, setIsLoading, setWordDataResponse }) => {
    const [query, setQuery] = useState<string>('')

    interface ErrorObject { value: boolean, message: string }
    const [error, setError] = useState<ErrorObject>({ value: false, message: '' })
    ...
    const handleSearch = useCallback((e: React.FormEvent, word: string) => {
        e.preventDefault()
    ...
    return (
        <form className="search-bar-container" onSubmit={(e) => handleSearch(e, query)} >
